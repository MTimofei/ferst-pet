...
func HandlingCookiesClients(urlserves *string, pagekesh *pars.HashTempl, key *crypto.PublicKey, w http.ResponseWriter, r *http.Request) (token *jwt.Token, err error) {
